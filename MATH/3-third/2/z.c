...
enum errors { success = 1, memory_error = -1 };
...
int find_norm(int count, Vector **max_norm, int *count_1, int *count_p, int *count_m, Vector **max_p_norm,
              Vector **max_A_norm, int p, int size, double **A, double (*get_norm)(Vector),
...
int main() {
    ...
    int result = find_norm(3, &max_norm, &count_1, &count_p, &count_m, &max_p_norm, &max_A_norm, p, size, A,
                           get_norm, get_p_norm, get_matrix_norm, v1, v2, v3);
