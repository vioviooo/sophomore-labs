...
int find_by_surname(Student* arr, int size, char surname[], Student** res) {
    for (int i = 0; i < size; i++) {
...
bool find_by_group(Student* arr, int size, char group[], Student** res) {
    for (int i = 0; i < size; i++) {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            if (type == ID) {
                ...
                if (find_by_id(arr, cnt, num, &found_student)) {
                    printf("Found!\nStudent info: ");
                    printf("%d %s %s %s ", found_student[0].id, found_student[0].surname, found_student[0].name, found_student[0].group);
                    for (int i = 0; i < num_exam; i++) {
                        printf("%hhu ", found_student[0].grades[i]);
                    }
                }
                else {
                    printf("Not found.");
                ...
                Student* found_student = (Student*)malloc(sizeof(Student));
                if (find_by_surname(arr, cnt, buf, &found_student)) {
                    printf("Found!\nStudent info: ");
                    printf("%d %s %s %s ", found_student[0].id, found_student[0].surname, found_student[0].name, found_student[0].group);
                    for (int i = 0; i < num_exam; i++) {
                        printf("%hhu ", found_student[0].grades[i]);
                ...
                Student* found_student = (Student*)malloc(sizeof(Student));
                if (find_by_name(arr, cnt, buf, &found_student)) {
                    printf("Found!\nStudent info: ");
                    printf("%d %s %s %s ", found_student[0].id, found_student[0].surname, found_student[0].name, found_student[0].group);
                    for (int i = 0; i < num_exam; i++) {
                        printf("%hhu ", found_student[0].grades[i]);
                ...
                Student* found_student = (Student*)malloc(sizeof(Student));
                if (find_by_group(arr, cnt, buf, &found_student)) {
                    printf("Found!\nStudent info: ");
                    printf("%d %s %s %s ", found_student[0].id, found_student[0].surname, found_student[0].name, found_student[0].group);
                    for (int i = 0; i < num_exam; i++) {
                        printf("%hhu ", found_student[0].grades[i]);
